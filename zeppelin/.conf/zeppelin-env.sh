...
export MASTER=spark://spark-master-svc.ibm-private-cloud:7077  # Spark master url. eg. spark://master_addr:7077. Leave empty if you want to use local mode.
export SPARK_APP_NAME=my-notebook               # (optional) The name of spark application.
